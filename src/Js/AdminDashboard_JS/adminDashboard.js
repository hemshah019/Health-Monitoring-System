...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function populateMessageModal(messageId) {
        ...
        if (message) {
            ...
            document.getElementById('message_view_patient_name').textContent = message.patientName;
    ...
    const compliance = complianceData[complianceId];
        ...
        if (compliance) {
            ...
            document.getElementById('compliance_view_patient_name').textContent = compliance.patientName;
            document.getElementById('compliance_view_patient_email').textContent = compliance.patientEmail;
    ...
    function populateImprovementModal(improvementId) {
        ...
        if (improvement) {
            ...
            document.getElementById('improvement_view_submitted_by').textContent = improvement.submittedBy;
            document.getElementById('improvement_view_email').textContent = improvement.email;
...
const messageResponseButtons = document.querySelectorAll('.response-btn[data-id^="M"]');

function populateMessageResponseForm(messageId) {
    const message = messageData[messageId];
    
    if (message) {
        document.getElementById('response_message_id').value = message.messageId;
        document.getElementById('response_patient_name').value = message.patientName;
        document.getElementById('response_message_type').value = message.messageType;
        document.getElementById('response_message_content').value = message.messageContent;
        document.getElementById('response_message_date').value = message.datetime;
...
messageResponseButtons.forEach(button => {
    button.addEventListener('click', function() {
        const messageId = this.getAttribute('data-id');
        populateMessageResponseForm(messageId);
        messageResponseModal.classList.add('active');
    });
});

closeMessageResponseModal.addEventListener('click', function() {
    messageResponseModal.classList.remove('active');
});

cancelMessageResponse.addEventListener('click', function() {
    messageResponseModal.classList.remove('active');
});
...
document.getElementById('messageResponseForm').addEventListener('submit', function(e) {
    e.preventDefault();
    const messageId = document.getElementById('response_message_id').value.replace('#', '');
    
    // Update the message data with the response
    messageData[messageId].adminResponse = document.getElementById('admin_response').value;
    messageData[messageId].status = document.getElementById('response_status').value;
...
const complianceResponseButtons = document.querySelectorAll('.response-btn[data-id^="C"]');

function populateComplianceResponseForm(complianceId) {
    const compliance = complianceData[complianceId];
    
    if (compliance) {
        document.getElementById('response_compliance_id').value = compliance.complianceId;
        document.getElementById('response_compliance_patient').value = compliance.patientName;
        document.getElementById('response_compliance_notes').value = compliance.notes;
        document.getElementById('response_compliance_date').value = compliance.date;
...
complianceResponseButtons.forEach(button => {
    button.addEventListener('click', function() {
        const complianceId = this.getAttribute('data-id');
        populateComplianceResponseForm(complianceId);
        complianceResponseModal.classList.add('active');
    });
});

closeComplianceResponseModal.addEventListener('click', function() {
    complianceResponseModal.classList.remove('active');
});

cancelComplianceResponse.addEventListener('click', function() {
    complianceResponseModal.classList.remove('active');
});
...
document.getElementById('complianceResponseForm').addEventListener('submit', function(e) {
    e.preventDefault();
    const complianceId = document.getElementById('response_compliance_id').value.replace('#', '');
    
    // Update the compliance data with the feedback
    complianceData[complianceId].adminFeedback = document.getElementById('admin_feedback').value;
...
const improvementResponseButtons = document.querySelectorAll('.response-btn[data-id^="I"]');

function populateImprovementResponseForm(improvementId) {
    const improvement = improvementData[improvementId];
    
    if (improvement) {
        document.getElementById('response_improvement_id').value = improvement.improvementId;
        document.getElementById('response_improvement_submitter').value = improvement.submittedBy;
        document.getElementById('response_improvement_category').value = improvement.category;
        document.getElementById('response_improvement_description').value = improvement.description;
        document.getElementById('response_improvement_date').value = improvement.dateSubmitted;
        
        // Set today's date as default for implementation date
        const today = new Date().toISOString().split('T')[0];
        document.getElementById('implementation_date').value = today;
    }
}
...
improvementResponseButtons.forEach(button => {
    button.addEventListener('click', function() {
        const improvementId = this.getAttribute('data-id');
        populateImprovementResponseForm(improvementId);
        improvementResponseModal.classList.add('active');
    });
});

closeImprovementResponseModal.addEventListener('click', function() {
    improvementResponseModal.classList.remove('active');
});

cancelImprovementResponse.addEventListener('click', function() {
    improvementResponseModal.classList.remove('active');
});
...
document.getElementById('improvementResponseForm').addEventListener('submit', function(e) {
    e.preventDefault();
    const improvementId = document.getElementById('response_improvement_id').value.replace('#', '');
    
    // Update the improvement data with the response
    improvementData[improvementId].adminResponse = document.getElementById('improvement_response').value;
    improvementData[improvementId].status = document.getElementById('improvement_status').value;
    improvementData[improvementId].implementationDate = document.getElementById('implementation_date').value;
